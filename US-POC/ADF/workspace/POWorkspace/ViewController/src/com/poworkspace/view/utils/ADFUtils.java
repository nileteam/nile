...
public class ADFUtils {
    ...
    public static String getPhaseName(int phaseId) {
        if (phaseId == Lifecycle.INIT_CONTEXT_ID)
            return "INIT_CONTEXT_ID (" + phaseId + ")";
        else if (phaseId == Lifecycle.PREPARE_MODEL_ID)
            return "PREPARE_MODEL_ID (" + phaseId + ")";
        else if (phaseId == Lifecycle.APPLY_INPUT_VALUES_ID)
            return "APPLY_INPUT_VALUES_ID (" + phaseId + ")";
        else if (phaseId == Lifecycle.VALIDATE_INPUT_VALUES_ID)
            return "VALIDATE_INPUT_VALUES_ID (" + phaseId + ")";
        else if (phaseId == Lifecycle.PROCESS_UPDATE_MODEL_ID)
            return "PROCESS_UPDATE_MODEL_ID (" + phaseId + ")";
        else if (phaseId == Lifecycle.VALIDATE_MODEL_UPDATES_ID)
            return "VALIDATE_MODEL_UPDATES_ID (" + phaseId + ")";
        else if (phaseId == Lifecycle.PROCESS_COMPONENT_EVENTS_ID)
            return "PROCESS_COMPONENT_EVENTS_ID (" + phaseId + ")";
        else if (phaseId == Lifecycle.PREPARE_RENDER_ID)
            return "PREPARE_RENDER_ID (" + phaseId + ")";
        else
            return "Other - (" + phaseId + ")";
    }
}
